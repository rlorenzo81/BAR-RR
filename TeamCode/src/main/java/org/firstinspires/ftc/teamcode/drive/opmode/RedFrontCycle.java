...
import org.firstinspires.ftc.teamcode.vision.SpikeDetectionRedFront;
import org.firstinspires.ftc.vision.VisionPortal;

/*
 * This is an example of a more complex path to really test the tuning.
 */
@Autonomous(name= "Red Front Cycle",group = "drive")
public class RedFrontCycle extends LinearOpMode {
    //@Override
    ...
    private SpikeDetectionRedFront spikeDetect;
...
*/
        ...
        Trajectory leftpurple = drive.trajectoryBuilder(startPose)
                .lineToLinearHeading(new Pose2d(-8, 29, Math.toRadians(0)))
                .build();
        ...
        Trajectory tostackleft = drive.trajectoryBuilder(leftpurple.end())
                .lineToLinearHeading(new Pose2d(-19, 26, Math.toRadians(-179)), SampleMecanumDrive.getVelocityConstraint(45, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                .build();

        Trajectory tostackcenter = drive.trajectoryBuilder(centerpurple.end())
                .lineToLinearHeading(new Pose2d(-19, 27, Math.toRadians(-179)), SampleMecanumDrive.getVelocityConstraint(45, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                .build();
        ...
        Trajectory backupstackleft = drive.trajectoryBuilder(tostackleft.end())
                .lineToLinearHeading(new Pose2d(-15, 27, Math.toRadians(-180)), SampleMecanumDrive.getVelocityConstraint(45, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                .build();
        ...
        Trajectory backtostackleft = drive.trajectoryBuilder(backupstackleft.end())
                .lineToLinearHeading(new Pose2d(-20, 27, Math.toRadians(-180)), SampleMecanumDrive.getVelocityConstraint(45, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                .build();
        ...
        Trajectory allignforboardleft = drive.trajectoryBuilder(leftpurple.end())
                .lineToLinearHeading(new Pose2d(-6, 2, Math.toRadians(-180)), SampleMecanumDrive.getVelocityConstraint(45, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                .build();
        ...
        Trajectory allignforboardright = drive.trajectoryBuilder(backtostackright.end())
                .lineToLinearHeading(new Pose2d(-6, 2, Math.toRadians(-180)), SampleMecanumDrive.getVelocityConstraint(35, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                .build();

        Trajectory throughtrussleft = drive.trajectoryBuilder(allignforboardleft.end())
                .lineToLinearHeading(new Pose2d(60, 4, Math.toRadians(-180)), SampleMecanumDrive.getVelocityConstraint(45, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                .build();
        ...
        Trajectory placeleft = drive.trajectoryBuilder(throughtrussleft.end())
                .lineToLinearHeading(new Pose2d(86.5, 32, Math.toRadians(-180)), SampleMecanumDrive.getVelocityConstraint(45, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                .build();

        Trajectory placecenter = drive.trajectoryBuilder(throughtrusscenter.end())
                .lineToLinearHeading(new Pose2d(86.5, 28, Math.toRadians(-180)), SampleMecanumDrive.getVelocityConstraint(45, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                .build();

        Trajectory placeright = drive.trajectoryBuilder(throughtrussright.end())
                .lineToLinearHeading(new Pose2d(86.5, 23, Math.toRadians(-180)), SampleMecanumDrive.getVelocityConstraint(45, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                .build();

        Trajectory parkleft = drive.trajectoryBuilder(placeleft.end())
                .lineToLinearHeading(new Pose2d(86, 1, Math.toRadians(-180)), SampleMecanumDrive.getVelocityConstraint(45, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                .build();
        ...
        Trajectory tuckleft = drive.trajectoryBuilder(parkleft.end())
                .lineToLinearHeading(new Pose2d(91, 1, Math.toRadians(-180)), SampleMecanumDrive.getVelocityConstraint(45, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                .build();
        ...
        spikeDetect = new SpikeDetectionRedFront();
        ...
        waitForStart();
        SpikeDetectionRedFront.Position position = spikeDetect.getPos();
