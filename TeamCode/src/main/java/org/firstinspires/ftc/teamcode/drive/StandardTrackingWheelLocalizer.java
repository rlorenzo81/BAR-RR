...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double LATERAL_DISTANCE = 12.133; // in; distance between the left and right wheels
    public static double FORWARD_OFFSET = -6.375; // in; offset of the lateral wheel

    public static double X_MULTIPLIER = 0.9908899; // Multiplier in the X direction
    public static double Y_MULTIPLIER = 0.997429; // Multiplier in the Y direction
