 ...
 */
@Autonomous(name= "OpenCV Red Front Board",group = "drive")
public class OpenCvRedFrontBoard extends LinearOpMode {
    //@Override
...
*/
        ...
        Trajectory leftpurple = drive.trajectoryBuilder(startPose)
                .lineToLinearHeading(new Pose2d(-8, 25, Math.toRadians(0)))
                .build();
        ...
        Trajectory allignforboardleft = drive.trajectoryBuilder(leftpurple.end())
                .lineToLinearHeading(new Pose2d(-6, 2, Math.toRadians(0)), SampleMecanumDrive.getVelocityConstraint(45, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                .build();

        Trajectory allignforboardcenter = drive.trajectoryBuilder(centerpurple.end())
                .lineToLinearHeading(new Pose2d(-6, 2, Math.toRadians(0)), SampleMecanumDrive.getVelocityConstraint(45, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                .build();

        Trajectory allignforboardright = drive.trajectoryBuilder(rightpurple.end())
        ...
        Trajectory throughtrussleft = drive.trajectoryBuilder(allignforboardleft.end())
                .lineToLinearHeading(new Pose2d(60, 4, Math.toRadians(0)), SampleMecanumDrive.getVelocityConstraint(45, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                .build();
        ...
        Trajectory placeleft = drive.trajectoryBuilder(throughtrussleft.end())
                .lineToLinearHeading(new Pose2d(86.5, 34.7, Math.toRadians(-180)), SampleMecanumDrive.getVelocityConstraint(45, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                .build();

        Trajectory placecenter = drive.trajectoryBuilder(throughtrusscenter.end())
                .lineToLinearHeading(new Pose2d(86.5, 28.5, Math.toRadians(-180)), SampleMecanumDrive.getVelocityConstraint(45, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                .build();

        Trajectory placeright = drive.trajectoryBuilder(throughtrussright.end())
                .lineToLinearHeading(new Pose2d(86.5, 21.5, Math.toRadians(-180)), SampleMecanumDrive.getVelocityConstraint(45, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                .build();
