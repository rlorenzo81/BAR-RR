...
@Autonomous(name= "OpenCV RED FRONT",group = "drive")
public class OpenCvRedFront extends LinearOpMode {
    //@Override
...
*/
        ...
        Trajectory leftpurple = drive.trajectoryBuilder(startPose)
                .lineToLinearHeading(new Pose2d(-7, 25, Math.toRadians(0)))
                .build();
        ...
        Trajectory allignforparkleft = drive.trajectoryBuilder(leftpurple.end())
                .lineToLinearHeading(new Pose2d(-2, 2, Math.toRadians(0)))
                .build();
        ...
        Trajectory parkcenter = drive.trajectoryBuilder(allignforparkcenter.end())
                .lineToLinearHeading(new Pose2d(90, 4, Math.toRadians(0)), SampleMecanumDrive.getVelocityConstraint(15, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                .build();

        Trajectory parkright = drive.trajectoryBuilder(allignforparkright.end())
                .lineToLinearHeading(new Pose2d(90, 4, Math.toRadians(0)), SampleMecanumDrive.getVelocityConstraint(15, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                .build();

        Trajectory droppixelleft = drive.trajectoryBuilder(parkleft.end())
                .lineToLinearHeading(new Pose2d(85, 6, Math.toRadians(180)), SampleMecanumDrive.getVelocityConstraint(15, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                .build();
        ...
        Trajectory moveback = drive.trajectoryBuilder(droppixelcenter.end())
                .lineToLinearHeading(new Pose2d(80, 4, Math.toRadians(180)), SampleMecanumDrive.getVelocityConstraint(15, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                .build();
